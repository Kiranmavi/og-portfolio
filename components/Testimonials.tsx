...
const testimonials = [
  ...
  {
    text: "kiran has an exceptional character and a positive, determined approach to challenges. As her mentor, I was impressed by her dedication and commitment to her work.",
  ...
  {
    text: "Managing kiran at Devsinc was a pleasure. She was a great asset to the team.",
  ...
  {
    text: "There are few times when you come across such bright minds like kiran.",
  ...
  {
    text: "kiran is a wonderful Role Model and a great mentee",
  ...
  {
    text: "kiran has always impressed me with her endless enthusiasm, and can-do attitude! She has a great future ahead as a brilliant software professional.",
    imageSrc: "/new-donut-pink.png",
    name: "Cigdem Sengul",
